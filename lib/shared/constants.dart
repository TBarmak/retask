...
const Color backgroundColor = Color(0xff011a27);
const Color backgroundColorTranslucent = Color(0x99011a27);
const Color accentColor1 = Color(0xffbab8bc);
const Color accentColor2 = Color(0xff063852);
